...
<div class="wp-block-group alignfull some-custom-class-if-needed">
  <!-- wp:heading -->
  <h3>Some heading that belongs to this block pattern.</h3><!-- /wp:heading -->
  <!-- wp:paragraph -->
  <p>Some paragraph that belongs to this block pattern.</p><!-- /wp:paragraph -->
  <!-- wp:paragraph -->
  <p>Some other paragraph that belongs to this block pattern.</p><!-- /wp:paragraph -->
</div>
<!-- /wp:group -->